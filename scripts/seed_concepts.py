...
CONCEPTS: list[dict] = [
    ...
    {"code": "代数-一元二次方程", "name": "一元二次方程基础",
     ...
     "aliases": _alias("代数", "一元二次方程", "一元二次方程基础", "二次方程", "方程"),
    ...
    {"code": "代数-数列-等差", "name": "等差数列", "prerequisite_codes": ["代数-整式运算"],
     "aliases": (
         _alias("代数", "等差数列", "数列-等差")
         + _alias("数列", "等差", "等差数列", "等差中项", "数列")  # 默认归入等差
     ),
     "description": "通项公式、求和公式、性质"},
    {"code": "代数-数列-等比", "name": "等比数列", "prerequisite_codes": ["代数-数列-等差"],
     "aliases": (
         _alias("代数", "等比数列", "数列-等比")
         + _alias("数列", "等比", "等比数列", "等比中项")
     ),
    ...
    {"code": "数据分析-组合", "name": "组合",
     ...
     "aliases": (
         _alias("数据分析", "组合", "组合数")
         + _alias("排列组合", "组合", "组合数", "选取", "选人", "分组", "分配")
     ),
    ...
    {"code": "数据分析-古典概率", "name": "古典概率",
     ...
     "aliases": (
         _alias("数据分析", "古典概率", "概率")
         + _alias("概率", "古典", "概率", "古典概型", "独立", "互斥", "条件")
         + _alias("排列组合", "古典", "概率", "古典概型")
     ),
     "description": "古典概型、互斥/独立事件、条件概率"},
    {"code": "数据分析-数据描述", "name": "数据描述",
     "prerequisite_codes": ["算术-平均数"],
     "aliases": (
         _alias("数据分析", "数据描述", "方差", "标准差", "中位数", "众数")
         + _alias("数据描述", "数据描述", "平均", "平均数", "方差", "标准差",
                 "中位数", "众数", "极差", "百分位")
     ),
